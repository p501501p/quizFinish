...
        private List<Student> StudentsDAta = new List<Student>();
...

        {
            ...
            InitializeComponent();
            TeachersA.Add(new Teacher("Dr. John Smith", "Mathematics", "Physics"));  // อาจารย์ในกลุ่ม A
            TeachersB.Add(new Teacher("Dr. Emily Johnson", "Computer Science", "Algorithms"));  // อาจารย์ในกลุ่ม B
            TeachersC.Add(new Teacher("Prof. Michael Brown", "Biology", "Genetics"));  // อาจารย์ในกลุ่ม C
            TeachersD.Add(new Teacher("Dr. Linda White", "Chemistry", "Organic Chemistry"));  // อาจารย์ในกลุ่ม D
        }
...

        {
            ...
            Teacher TeacherAdd = new Teacher("Dr. John Smith", "Math", "Physics");
